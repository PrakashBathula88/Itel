    ...
    <div className=" justify-between md:p-10 bg-white animate-slide-in">
      ...
      <div className="flex">
        ...
        <div className="text-black w-80 m-40 my-24 gap-20 ">
          ...
          <p>
            Since IKEA started its corporate design and procurement services in
            ...
            products and customized solutions for every industry at IKEA. We
            support spot deliveries and fast installation to help you seize
            business opportunities.
          </p>
          <p>
            <u className=" text-black font-bold">Become an IKEA Business member</u> and
            enjoy exclusive benefits
          </p>
          <a href="https://www.ikea.cn/cn/en/ikea-business/commercial-spaces-for-msmes-pub95dc1e29">
